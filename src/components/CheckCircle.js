...
class CheckCircle extends Component {
    render () {
        return (
                    <svg viewBox="0 0 36 36" style={{height: '100px'}}>
                        <path style={{ fill: 'none', stroke: '#51c47c', strokeWidth: '2.8' }} d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"></path>
